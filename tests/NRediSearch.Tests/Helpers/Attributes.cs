...
namespace NRediSearch.Tests
{
    ...
    [XunitTestCaseDiscoverer("NRediSearch.Tests.FactDiscoverer", "NRediSearch.Tests")]
    ...
    /// </summary>
    [AttributeUsage(AttributeTargets.Method, AllowMultiple = false)]
    [XunitTestCaseDiscoverer("NRediSearch.Tests.TheoryDiscoverer", "NRediSearch.Tests")]
    ...
    internal static class XUnitExtensions
    {
        internal static string StripName(this string name) =>
            name.Replace("NRediSearch.Tests.", "");
